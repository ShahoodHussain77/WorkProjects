...
import { Text, View, Image, AsyncStorage, ScrollView, StyleSheet, Dimensions, TextInput, TouchableOpacity, Modal, FlatList  } from 'react-native'
...
class EmployeeRegThree extends Component {
            ...
            data: [
                {
                    ...
                    "dialling_code": "+93",
                    "icon_path": "https://www.countryflags.io/AF/shiny/64.png"
                },
                {
                    "country_code": "AL",
                    "country_name": "Albania",
                    "dialling_code": "+355",
                    "icon_path": "https://www.countryflags.io/AL/shiny/64.png"
                },
                {
                    "country_code": "DZ",
                    "country_name": "Algeria",
                    "dialling_code": "+213",
                    "icon_path": "https://www.countryflags.io/DZ/shiny/64.png"
                },
                {
                    "country_code": "AS",
                    "country_name": "American Samoa",
                    "dialling_code": "+1",
                    "icon_path": "https://www.countryflags.io/AS/shiny/64.png"
                },
                {
                    "country_code": "AD",
                    "country_name": "Andorra",
                    "dialling_code": "+376",
                    "icon_path": "https://www.countryflags.io/AD/shiny/64.png"
                },
                {
                    "country_code": "AO",
                    "country_name": "Angola",
                    "dialling_code": "+244",
                    "icon_path": "https://www.countryflags.io/AO/shiny/64.png"
                },
                {
                    "country_code": "AI",
                    "country_name": "Anguilla",
                    "dialling_code": "+1",
                    "icon_path": "https://www.countryflags.io/AI/shiny/64.png"
                },
                {
                    "country_code": "AG",
                    "country_name": "Antigua",
                    "dialling_code": "+1",
                    "icon_path": "https://www.countryflags.io/AG/shiny/64.png"
                },
                {
                    "country_code": "AR",
                    "country_name": "Argentina",
                    "dialling_code": "+54",
                    "icon_path": "https://www.countryflags.io/AR/shiny/64.png"
                },
                {
                    "country_code": "AM",
                    "country_name": "Armenia",
                    "dialling_code": "+374",
                    "icon_path": "https://www.countryflags.io/AM/shiny/64.png"
                },
                {
                    "country_code": "AW",
                    "country_name": "Aruba",
                    "dialling_code": "+297",
                    "icon_path": "https://www.countryflags.io/AW/shiny/64.png"
                },
                {
                    "country_code": "AU",
                    "country_name": "Australia",
                    "dialling_code": "+61",
                    "icon_path": "https://www.countryflags.io/AU/shiny/64.png"
                },
                {
                    "country_code": "AT",
                    "country_name": "Austria",
                    "dialling_code": "+43",
                    "icon_path": "https://www.countryflags.io/AT/shiny/64.png"
                },
                {
                    "country_code": "AZ",
    ...
    validateAndSignUp() {
        if( numberCheck === true && this.state.number && this.state.number != '' ) {
            this.setState({
                isLoading: true
            })
            const navigation = this.props.navigation;
            fetch(`${Constants.BASE_URL}validate_company_and_emp_signup.php`,{
                method: 'POST',
                headers: {
            ...
            .then((responseJson) => {
                if(responseJson && responseJson != ''){
                    ...
                    AsyncStorage.setItem('CompanyCode', navigation.getParam('companyCode'));
                    ...
                    this.refs.toast.show(
                        <View style={{paddingLeft: (width-200)/1.6, paddingRight: (width-200)/1.6}}>
                            <Text style={{color: '#ddd', width: '100%'}}>Unable to signup</Text>
                        </View>, 2000, () => {
    ...
    setNumber(event) {
        if( isNaN(event) ) {
            validateNumber = <Text style={{ color: 'red' }}>Invalid Number</Text>;
            numberCheck = false;
            this.setState({
                number: ''
            })
    ...
    setCountry(country) {
        this.setState({
            ...
            dialingCode: country.dialling_code
        })
    }
    ...
    render() {
        ...
        const flag_image = this.state.countryCode != '' ? <Image style={{width: 30, height: 20, marginRight: 5}} source={{uri: `https://www.countryflags.io/${this.state.countryCode}/shiny/64.png`}} /> : <Text></Text>
            ...
            <View style={{flex: 1}}>
                <ScrollView style={styles.container} contentContainerStyle={{flexGrow:1}}>
                    <View style={styles.mainContainer}>
                        ...
                        <View style={styles.secondSection}>
                            <View style={styles.openCountryModal}>
                                <TouchableOpacity
                                ...
                                style={{flexDirection: 'row'}}>
                                    {flag_image}
                                    <Text style={{color: '#ddd', fontSize: 20}}>{this.state.countryName ? this.state.countryName : 'Select Country'}</Text>
                                    <Icon style={styles.arrrow} name="md-arrow-round-down" size={20} color="#ddd" />
                                </TouchableOpacity>
                            </View>
                            ...
                            <View style={{flex: 1, flexDirection: 'row'}}>
                                {
                                    ...
                                    <TextInput style={styles.showDialingCode} 
                                    editable={false}
                                    placeholder={this.state.dialingCode}
                                    placeholderTextColor="#ddd"/> : <View></View>
                                }
                                <TextInput
                                    placeholder="NUMBER"
                ...
                <Modal
                    ...
                    <View style={styles.modalContainer}>
                        ...
                        renderItem={({item}) => {
                            let code = `https://www.countryflags.io/${item.country_code}/shiny/64.png`;
                            return(
                                <TouchableOpacity style={styles.selectCountry}
                                onPress={() => this.setCountry(item)}
                                key={item.country_code}>
                                    <Image style={{width: 20, height: 20}} source={{uri: code}}/>
                                    <View style={{paddingLeft: 10}}></View>
                                    <Text style={styles.countryNames}>{item.country_name}</Text>
                                </TouchableOpacity>
                            )
                        }}/>
                    </View>
