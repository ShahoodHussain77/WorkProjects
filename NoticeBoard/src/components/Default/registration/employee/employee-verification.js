...
import { Text, View, TouchableOpacity, TextInput, AsyncStorage, Dimensions, StyleSheet } from 'react-native'
...
export class EmployeeVerification extends Component {
    ...
    async verifyUser() {
        ...
        fetch(`${Constants.BASE_URL}check_employee_verification_code.php`,{
            method: 'POST',
            headers: {
