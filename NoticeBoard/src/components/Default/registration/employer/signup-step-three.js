...
import { View, Text, StyleSheet, ScrollView, TouchableOpacity, Dimensions, TextInput, FlatList, AsyncStorage, Modal, Image } from 'react-native';
...
class SignUpThree extends Component {
    ...
    gotoNextStep() {
        if (numberCheck === true) {
                ...
                .then((responseJson) => {
                    ...
                    this.refs.toast.show(
                        <View style={{paddingLeft: (width-200)/1.9, paddingRight: (width-200)/1.9}}>
                            <Text style={{color: '#ddd', width: '100%'}}>Server Under Maintenance</Text>
                        </View>, 2000, () => {
            ...
            this.refs.toast.show(
                <View style={{paddingLeft: (width-200)/1.9, paddingRight: (width-200)/1.9}}>
                    <Text style={{color: '#ddd', width: '100%'}}>Invalid Number</Text>
                </View>, 2000, () => {
                // something you want to do at close
            });
        }
    ...
    render() {
        ...
        return (
            <View style={{flex: 1}}>
                <ScrollView style={styles.container} behavior="padding" enabled contentContainerStyle={{flexGrow:1}}>
